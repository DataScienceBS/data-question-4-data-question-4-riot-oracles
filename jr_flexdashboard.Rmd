...
label_create_high <- function(x_var, y_var, text_label) {
  list(
  x = x_var,
  y = y_var,
  text = text_label,
...
label_create_low <- function(x_var, y_var, text_label) {
  list(
  x = x_var,
  y = y_var,
  text = text_label,
...
high_score_math <- label_create_low(high_score_math_county$Pct_ED, 
             high_score_math_county$Pct_proficient,
             "")

low_score_math <- label_create_low(low_score_math_county$Pct_ED,
                               low_score_math_county$Pct_proficient,
                               "")

high_score_science <- label_create_high(high_score_science_county$Pct_ED,
                               high_score_science_county$Pct_proficient,
                               "Williamson County")

low_score_science <- label_create_high(low_score_science_county$Pct_ED,
                               low_score_science_county$Pct_proficient,
                               "Humboldt City")
